...
from app.modules.legal_library.presentation.schemas.article_schemas import (
    ArticleCreateRequest, ArticleResponse, SearchRequest, SearchResult
)
from app.modules.legal_library.application.use_cases.create_article import CreateArticleUseCase
from app.modules.legal_library.application.use_cases.search_articles import SearchArticlesUseCase
from app.modules.legal_library.application.use_cases.bulk_ingest import BulkIngestUseCase
from app.modules.legal_library.presentation.dependencies.legal_deps import (
    get_create_article_use_case, get_search_articles_use_case, get_bulk_ingest_use_case
)
